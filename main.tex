...
invalid for flexible structured data such as code.
...
The following describes an example of where our tool successfully merges
...
Paper prototypes will be used to evaluate the feasibility of the 
User Interface design of our tool. This study will reveal both fundamental
...
two code artefacts. The PDStore database will be used to compare
